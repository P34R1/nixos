...
# background
function _jj_prompt_async_worker --on-event fish_prompt
    command kill $_jj_prompt_last_pid 2>/dev/null # avoid race condition
    ...
    fish --private --command '
        ...
        set --universal '$_jj_prompt' (string join " " -- (set_color magenta)$JJ_AT (set_color blue)$JJ_DESC$JJ_DIFF)
    ' &
